...
import logo from '/src/assets/favicon/logo.png';
                                        ...
                                        {navigation.map((item) => (
                                            <a
                                                ...
                                                className={classNames(
                                                    item.current ? 'font-semibold text-blue-400' : 'text-slate-100 hover:text-blue-400',
                                                    'rounded-md px-4 py-1 text-sm font-normal'
                                                )}
